...
void UART2_int (void) interrupt UART2_VECTOR
{
	...
	{
		CLR_TI2();
		if(COM2.TX_read != COM2.TX_write)		//Ã»ÓÐÍê³É·¢ËÍ
		{
		 	S2BUF = TX2_Buffer[COM2.TX_read];	//¼ÌÐø·¢ËÍ
			if(++COM2.TX_read >= COM_TX2_Lenth)		COM2.TX_read = 0;	//Ô½½ç´¦Àí
		}
		else	COM2.B_TX_busy = 0;			//½áÊø·¢ËÍ
	}
}
/****************************************************************************************
